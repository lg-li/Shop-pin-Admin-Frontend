  ...
  <div class="home-container">
    <el-row :gutter="20">
      ...
      <el-col :xs="24" :sm="6" :lg="6">
        <el-card class="right-card" style="text-align:center">
    ...
    <el-dialog top="2vh" :title="dialogType===1?'修改店铺信息':'创建店铺'" :visible.sync="changeStoreDialog"
      ...
      <el-form ref="dataForm" :model="storeTemp" label-position="left" label-width="70px" style="margin:16px;">
        ...
        <el-form-item label="店铺图片" prop="url">
          ...
          />
          <el-image
            v-if="storeTemp.logo_url"
            :src="storeTemp.logo_url"
            style="width: 81%; height: 54%"
            :fit="scale-down"
          />
        </el-form-item>
      </el-form>
